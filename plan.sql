...
USE ROLE SYSADMIN;
CREATE WAREHOUSE IF NOT EXISTS prod_phdata WAREHOUSE_SIZE = 'XSMALL', INITIALLY_SUSPENDED = true;
USE ROLE SYSADMIN;
...
USE ROLE SYSADMIN;
CREATE DATABASE IF NOT EXISTS prod_phdata;
USE ROLE SYSADMIN;
...
USE ROLE SECURITYADMIN;
CREATE ROLE IF NOT EXISTS prod_phdata_RW;
USE ROLE SECURITYADMIN;
CREATE ROLE IF NOT EXISTS prod_phdata_RO;
USE ROLE SECURITYADMIN;
...
USE ROLE SECURITYADMIN;
CREATE USER IF NOT EXISTS testuser1 EMAIL = 'testuser1@phdata.io', DEFAULT_ROLE = WS_testuser1, LOGIN_NAME = 'testuser1', DEFAULT_WAREHOUSE = USER_WH1;
USE ROLE SECURITYADMIN;
CREATE USER IF NOT EXISTS testuser2 EMAIL = 'testuser2@phdata.io', DEFAULT_ROLE = WS_testuser2, LOGIN_NAME = 'testuser2', DEFAULT_WAREHOUSE = USER_WH1;
USE ROLE SECURITYADMIN;
...
USE ROLE SECURITYADMIN;
GRANT ALL PRIVILEGES ON DATABASE prod_phdata TO ROLE prod_phdata_RW;
USE ROLE SECURITYADMIN;
GRANT USAGE ON DATABASE prod_phdata TO ROLE prod_phdata_RO;
USE ROLE SECURITYADMIN;
GRANT USAGE ON WAREHOUSE prod_phdata TO ROLE prod_phdata_RO;
USE ROLE SECURITYADMIN;
...
USE ROLE SECURITYADMIN;
GRANT ROLE prod_phdata_RO TO ROLE prod_phdata_RW;
USE ROLE SECURITYADMIN;
...
USE ROLE SYSADMIN;
CREATE SCHEMA IF NOT EXISTS prod_phdata.RAW;
USE ROLE SYSADMIN;
CREATE SCHEMA IF NOT EXISTS prod_phdata.STAGING;
USE ROLE SYSADMIN;
CREATE SCHEMA IF NOT EXISTS prod_phdata.CURATED;
USE ROLE SYSADMIN;
...
USE ROLE SECURITYADMIN;
GRANT USAGE ON all schemas in database prod_phdata TO ROLE prod_phdata_RO;
USE ROLE SECURITYADMIN;
GRANT ALL PRIVILEGES ON SCHEMA prod_phdata.RAW TO ROLE prod_phdata_RW;
USE ROLE SECURITYADMIN;
GRANT ALL PRIVILEGES ON SCHEMA prod_phdata.STAGING TO ROLE prod_phdata_RW;
USE ROLE SECURITYADMIN;
GRANT ALL PRIVILEGES ON SCHEMA prod_phdata.CURATED TO ROLE prod_phdata_RW;
USE ROLE SECURITYADMIN;
...
USE ROLE SECURITYADMIN;
GRANT SELECT ON future tables in schema prod_phdata.RAW TO ROLE prod_phdata_RO;
USE ROLE SECURITYADMIN;
GRANT SELECT ON future tables in schema prod_phdata.STAGING TO ROLE prod_phdata_RO;
USE ROLE SECURITYADMIN;
GRANT SELECT ON future tables in schema prod_phdata.CURATED TO ROLE prod_phdata_RO;
